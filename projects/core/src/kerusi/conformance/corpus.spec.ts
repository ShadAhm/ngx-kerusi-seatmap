...
import {
  ...
  errorsOf,
} from '../kerusi-validator.js';
import { KerusiViolation } from '../kerusi-violation.js';

// --- valid ------------------------------------------------------------------
import busMinimal from './corpus/bus-minimal.map.kerusi.json' with { type: 'json' };
import cinemaHallA from './corpus/cinema-hallA.map.kerusi.json' with { type: 'json' };
import cinemaHallBGrid from './corpus/cinema-hallB-grid.map.kerusi.json' with { type: 'json' };
import deltaHeartbeat from './corpus/delta-heartbeat.statedelta.kerusi.json' with { type: 'json' };
import deltaRelease from './corpus/delta-release.statedelta.kerusi.json' with { type: 'json' };
import flightB738 from './corpus/flight-b738.map.kerusi.json' with { type: 'json' };
import mixedRowOnlyElement from './corpus/mixed-row-only-element.map.kerusi.json' with { type: 'json' };
import sessionMh123 from './corpus/session-mh123.session.kerusi.json' with { type: 'json' };
import stadiumMixed from './corpus/stadium-mixed.map.kerusi.json' with { type: 'json' };
import stageOnlySection from './corpus/stage-only-section.map.kerusi.json' with { type: 'json' };
import stateByMapId from './corpus/state-by-mapid.state.kerusi.json' with { type: 'json' };
import stateBySessionId from './corpus/state-by-sessionid.state.kerusi.json' with { type: 'json' };
import stateEmpty from './corpus/state-empty.state.kerusi.json' with { type: 'json' };

// --- schema-invalid ---------------------------------------------------------
import badCurrency from './corpus/invalid/bad-currency.map.kerusi.json' with { type: 'json' };
import degenerateAspectRatio from './corpus/invalid/degenerate-aspect-ratio.map.kerusi.json' with { type: 'json' };
import deltaBothScopes from './corpus/invalid/delta-both-scopes.statedelta.kerusi.json' with { type: 'json' };
import deltaMissingChanges from './corpus/invalid/delta-missing-changes.statedelta.kerusi.json' with { type: 'json' };
import freeformSeatWithCol from './corpus/invalid/freeform-seat-with-col.map.kerusi.json' with { type: 'json' };
import gridElementFractionalSpan from './corpus/invalid/grid-element-fractional-span.map.kerusi.json' with { type: 'json' };
import gridElementWithXy from './corpus/invalid/grid-element-with-xy.map.kerusi.json' with { type: 'json' };
import gridSeatWithXy from './corpus/invalid/grid-seat-with-xy.map.kerusi.json' with { type: 'json' };
import mapBadVersion from './corpus/invalid/map-bad-version.map.kerusi.json' with { type: 'json' };
import mapMissingLegend from './corpus/invalid/map-missing-legend.map.kerusi.json' with { type: 'json' };
import mapUnknownToplevelField from './corpus/invalid/map-unknown-toplevel-field.map.kerusi.json' with { type: 'json' };
import mixedElementFractionalSpan from './corpus/invalid/mixed-element-fractional-span.map.kerusi.json' with { type: 'json' };
import mixedSeatMissingXy from './corpus/invalid/mixed-seat-missing-xy.map.kerusi.json' with { type: 'json' };
import nonIntegerAmount from './corpus/invalid/non-integer-amount.map.kerusi.json' with { type: 'json' };
import seatNoPosition from './corpus/invalid/seat-no-position.map.kerusi.json' with { type: 'json' };
import sessionMissingMapId from './corpus/invalid/session-missing-mapid.session.kerusi.json' with { type: 'json' };
import stateBadStatus from './corpus/invalid/state-bad-status.state.kerusi.json' with { type: 'json' };
import stateBadTimestamp from './corpus/invalid/state-bad-timestamp.state.kerusi.json' with { type: 'json' };
import stateBothScopes from './corpus/invalid/state-both-scopes.state.kerusi.json' with { type: 'json' };
import stateIso8601NoSeconds from './corpus/invalid/state-iso8601-no-seconds.state.kerusi.json' with { type: 'json' };
import stateNoScope from './corpus/invalid/state-no-scope.state.kerusi.json' with { type: 'json' };

// --- semantically invalid ---------------------------------------------------
import asymmetricCompanions from './corpus/validator-only/asymmetric-companions.map.kerusi.json' with { type: 'json' };
import danglingPriceTier from './corpus/validator-only/dangling-price-tier.map.kerusi.json' with { type: 'json' };
import danglingRow from './corpus/validator-only/dangling-row.map.kerusi.json' with { type: 'json' };
import danglingSeatType from './corpus/validator-only/dangling-seat-type.map.kerusi.json' with { type: 'json' };
import duplicateSeatIds from './corpus/validator-only/duplicate-seat-ids.map.kerusi.json' with { type: 'json' };
import elementRowspanOverruns from './corpus/validator-only/element-rowspan-overruns.map.kerusi.json' with { type: 'json' };
import inferredLayoutInconsistent from './corpus/validator-only/inferred-layout-inconsistent.map.kerusi.json' with { type: 'json' };
import mixedCurrencies from './corpus/validator-only/mixed-currencies.map.kerusi.json' with { type: 'json' };
